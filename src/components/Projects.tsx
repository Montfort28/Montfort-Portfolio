      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-16">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-mauve to-peach text-white font-semibold rounded-lg hover:shadow-glow-mauve transition-all duration-300 group"
          >
        ...
        <div className="mt-20 bg-white rounded-2xl p-8 md:p-12 shadow-soft border border-neutral-gray">
          <div className="max-w-3xl mx-auto text-center">
            <svg className="w-12 h-12 mx-auto mb-6 text-mauve/30" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <p className="text-mauve font-display font-bold text-lg">Mugisha Montfort</p>
