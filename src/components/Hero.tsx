  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-beige via-ivory to-neutral-gray overflow-hidden pt-20 pb-10">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-5 w-96 h-96 rounded-full bg-mauve/10 blur-3xl"></div>
        <div className="absolute bottom-32 right-10 w-80 h-80 rounded-full bg-peach/10 blur-3xl"></div>
        <div className="absolute top-1/3 right-1/4 w-64 h-64 rounded-full bg-mauve/5 blur-2xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 z-10 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-16">
          ...
          <div className="space-y-8 animate-fadeInUp">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold text-espresso leading-tight mb-4">
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-mauve via-peach to-mauve">
                  {personalInfo.name.split(' ').slice(2).join(' ')}
                </span>
              </h1>
              <p className="text-xl md:text-2xl text-mauve font-semibold mb-4">
                {personalInfo.role}
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link
                to="/projects"
                className="px-8 py-4 bg-gradient-to-r from-mauve to-peach text-white font-semibold rounded-lg transition-all duration-300 hover:shadow-glow-mauve transform hover:scale-105 text-center"
              >
                View My Projects
              </Link>
              <a
                ...
                download
                className="px-8 py-4 border-2 border-mauve text-mauve hover:bg-mauve hover:text-white font-semibold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 group"
              >
            ...
            <div className="flex gap-6 pt-4">
              <a
                ...
                className="group p-3 rounded-full bg-neutral-gray hover:bg-mauve transition-all duration-300 hover:shadow-glow-mauve"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group p-3 rounded-full bg-neutral-gray hover:bg-peach transition-all duration-300 hover:shadow-glow-peach"
              >
                <svg className="w-6 h-6 text-espresso group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a
                ...
                className="group p-3 rounded-full bg-neutral-gray hover:bg-gradient-to-r hover:from-mauve hover:to-peach transition-all duration-300 hover:shadow-glow-mauve"
              >
          ...
          <div className="flex justify-center animate-slideInRight">
            <div className="relative">
              ...
              <div className="absolute inset-0 w-80 h-80 rounded-full bg-gradient-to-br from-mauve/20 to-peach/20 blur-xl"></div>
              <div className="absolute inset-12 w-56 h-56 rounded-full bg-gradient-to-br from-peach/10 to-mauve/10 blur-lg"></div>
              ...
              <div className="absolute -bottom-8 -left-8 bg-white rounded-2xl p-4 shadow-lg backdrop-blur-sm border border-neutral-gray">
                ...
                <p className="text-2xl font-display font-bold text-mauve">Engineer</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Tech Stack Section */}
        <div className="mt-24">
          <p className="text-center text-sm uppercase tracking-[0.2em] text-mauve font-semibold mb-8">
