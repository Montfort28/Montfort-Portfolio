...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#0E0E0E] text-gray-400 py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-2 max-w-md">
              Full-Stack Developer passionate about creating responsive, user-friendly web applications.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm">
          <p>
            Designed and built with <span className="text-red-500">♥</span> by Mugisha Louis Marie De Montfort
          </p>
        </div>
      </div>
    </footer>
