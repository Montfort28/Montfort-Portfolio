...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-ivory to-beige border-t border-neutral-gray">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="animate-fadeInUp">
            ...
            <p className="text-espresso/70 leading-relaxed max-w-xs">
          ...
          <div className="animate-slideInRight">
            <h4 className="font-display font-semibold text-espresso mb-6">Follow</h4>
            <div className="space-y-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 text-espresso/70 hover:text-peach transition-colors group"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Divider */}
        <div className="h-px bg-gradient-to-r from-transparent via-mauve/50 to-transparent my-12"></div>

        {/* Bottom Section */}
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-espresso/60">
          <p>
            © {currentYear} Mugisha Louis Marie De Montfort. All rights reserved.
          </p>
          <p>
            Crafted with <span className="text-peach">✨</span> using Next.js, PostgreSQL & React
          </p>
        </div>
      </div>
    </footer>
